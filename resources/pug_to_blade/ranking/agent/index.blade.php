...
<html lang="ja">
  ...
  <body>   
    <div class="l-wrapper" id="p-agent">
        ...
        <div class="c-hero c-hero__site">
          <div class="l-inner">
            <div class="ui breadcrumb">           
              <div class="c-breadcrumb"><a class="section" href="#">HOME</a><i class="right angle icon divider"></i><a class="section" href="#">転職サイト・Agent</a><i class="right angle icon divider"></i>
        ...
        <div class="l-inner l-row">
          <main class="l-col-lg-8">
            ...
            <div class="l-main_lf_2">
              <div class="c-ranking">
                <h2 class="c-ranking__title"><span>第１位</span>リクルートエージェント</h2>
                ...
                <div class="c-ranking__description">
                  <div class="c-ranking__section"><span class="c-ranking__catch">ここがポイント<i class="pointing up icon"></i></span>
                    <ul class="c-ranking__points">
                      <li class="c-ranking__point"><i class="checkmark icon c-ranking__pointIcon">           </i>17万件という業界最大規模の取り扱い求人数(*)</li>
                      <li class="c-ranking__point"><i class="checkmark icon c-ranking__pointIcon"></i>30万人の転職成功者実績という圧倒的な安心感</li>
                      <li class="c-ranking__point"><i class="checkmark icon c-ranking__pointIcon"></i>きめ細やかな面談・ヒアリングとそれにもとづく求人の提案力</li>
                    </ul>
                  </div>
                  <div class="c-ranking__section"><span class="c-ranking__catch">利用者の声<i class="talk outline icon"></i></span>
                    <div class="ui comments c-voices">
                      ...
                      <div class="ui raised segment">
                        <div class="comment c-voice">
                          <div class="c-voice__author"><a class="avatar c-voice__avatar"><span class="c-voice__avatar20m"></span></a>
                            <div class="content c-voice__meta"><a class="author">20代 男性 販売職</a>
                              <div class="metadata">
                                <div class="ui star rating disabled" data-rating="4" data-max-rating="5"></div>
                              </div>
                            </div>
