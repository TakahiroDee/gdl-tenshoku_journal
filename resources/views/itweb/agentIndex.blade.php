      ...
      <main class="l-col-lg-8">
        ...
        <div class="l-main_lf_1">
          <p class="ui tabular menu c-tabmenu">
            <a class="item c-tabmenu__item" id="frag-all" href="/ranking/itweb/#frag-all">
              全サービス一覧
            </a>
            <a class="active item c-tabmenu__item" id="frag-agent" href="/ranking/itweb/agent/#frag-agent">
              転職エージェント<wbr/>ランキング
            </a>
        ...
        <div class="l-main_lf_2">
          ...
          @foreach($rankings as $ranking)
            ...
            <div class="c-ranking">
              <h2 class="c-ranking__title"><span>第{{ $loop->index + 1}}位</span>{{ $ranking->service_jp_name }}</h2>
              ...
              <div class="c-ranking__description">
                ...
                <div class="c-double__buttons">
                  <button class="ui orange button c-button"><a href="{{ action('AgentController@show', $ranking->service_id) }}">クチコミ・詳細を見る</a></button>
