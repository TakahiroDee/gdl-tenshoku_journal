...
{{-- l-wrapper's id --}}
@section('page-id','p-agent')

@section('content')
<div class="l-hero">
  <div class="c-hero c-hero__agent">
    <div class="l-inner">
      <div class="ui breadcrumb">
        <div class="c-breadcrumb">
          ...
          <i class="right angle icon divider"></i>
          <div class="section">転職エージェント徹底比較ランキング</div>
        </div>
      </div>
      ...
      <div class="l-main_lf_2">
        ...
        <div class="c-ranking">
          ...
          <div class="ui items c-ranking__summary">
            <div class="item">
              <a href="{{ action('AgentController@show', $ranking->service_id )}}" class="ui small image"
