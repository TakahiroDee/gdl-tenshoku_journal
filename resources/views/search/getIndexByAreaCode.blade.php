...
<div class="l-inner">
  <div class="ui breadcrumb">
    <div class="c-breadcrumb u-lg-ms1rem">
      ...
      <i class="right angle icon divider"></i>
      <div class="section">{{ $data['area_code_value']}}の求人検索結果</div>
    </div>
  </div>
</div>
<main class="l-main">
  ...
  <div class="l-inner l-row l-col">
    <div class="l-col-lg-8">
      <h1>{{ $data['area_code_value'] }}の求人検索結果</h1>
      ...
      <div class="l-main_lf_2">
        ...
        <div class="c-searchCassette ui grey segment">
          <h2 class="c-searchCassette__title">
            <a href="{{ action('SearchController@showByAreaCode', [$data['block_pathname'], $cassette->area_pathname, $cassette->rqmt_id] )}}">
              {{ $cassette->cmpny_name }}
            </a>
          </h2>
          ...
          <div class="c-searchCassette__buttons">
            ...
            <div class="c-searchCassette__button ui teal button">
              <a class="c-searchCassette__link" href="{{ action('SearchController@showByAreaCode', [$data['block_pathname'], $cassette->area_pathname, $cassette->rqmt_id] )}}">
                求人の詳細を見る
              </a>
            </div>
          </div>
