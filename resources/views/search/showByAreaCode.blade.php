...
<div class="l-inner">
  <div class="ui breadcrumb">
    <div class="c-breadcrumb u-lg-ms1rem">
      ...
      <i class="right angle icon divider"></i>
      <a class="section" href="{{ action('SearchController@getIndexByBlockCode',$data['block_pathname'])}}">
        {{ $data['block_code_value']}}
      </a>
      <i class="right angle icon divider"></i>
      <a class="section" href="{{ action('SearchController@getIndexByAreaCode', [$data['block_pathname'], $data['area_pathname']]) }}">
  ...
  <div class="l-inner l-row l-col">
    <main class="l-col-lg-12">
          ...
          <div class="ui items">
            <div class="item">
              <a class="ui small image">
                <img class="c-ranking__thumb" src="/dist/image/{{ $data['rankingContent']->thumbnail_path }}">
              </a>
              <div class="content">
      ...
      <div class="l-main_lf_3">
        <h2>{{ $data['rankingContent']->service_jp_name }}が扱うこのエリアでの別の求人</h2>
        ...
        @endif
          ...
          <div class="ui card">
            ...
            <div class="extra content">
              <a class="ui olive button" href="{{ action('SearchController@showByAreaCode', [$data['block_pathname'], $data['area_pathname'], $job->rqmt_id]) }}">詳細をみる</a>
            </div>
          </div>
          @endforeach
        </div>
