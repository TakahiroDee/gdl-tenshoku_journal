...
<div class="l-inner">
  <div class="ui breadcrumb">
    <div class="c-breadcrumb u-lg-ms1rem">
      ...
      <i class="right angle icon divider"></i>
      <a class="section" href="{{ action('SearchController@getIndexByJobBigCode',$data['pathname']) }}">{{ $data['job_code_big_value'] }}</a>
      <i class="right angle icon divider"></i>
      <div class="section">{{ $data['job_code_mid_value'] }}の求人検索結果</div>
    </div>
  </div>
</div>
<main class="l-main">
  ...
  <div class="l-inner l-row l-col">
    <div class="l-col-lg-8">
      <h1>{{ $data['job_code_mid_value'] }}の求人検索結果</h1>
      ...
      <div class="l-main_lf_2">
        ...
        <div class="c-searchCassette ui grey segment">
          <h2 class="c-searchCassette__title">
            <a href="{{ action('SearchController@showByJobCode', [$data['pathname'], $cassette->job_code_full, $cassette->rqmt_id] )}}">
              {{ $cassette->cmpny_name }}
            </a>
          </h2>
          <p class="c-searchCassette__lead">
            <a class="c-searchCassette__link">{{ $cassette->subtitle }}</a>
          </p>
          ...
          <div class="c-searchCassette__buttons">
            ...
            <div class="c-searchCassette__button ui teal button">
              <a class="c-searchCassette__link" href="{{ action('SearchController@showByJobCode', [$data['pathname'], $cassette->job_code_full, $cassette->rqmt_id] )}}">
                求人の詳細を見る
              </a>
            </div>
          </div>
