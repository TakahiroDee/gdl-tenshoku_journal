...
{{-- l-wrapper's id --}}
@section('page-id','p-woman')

@section('content')
<div class="l-hero">
  <div class="c-hero c-hero__woman">
    <div class="l-inner">
      <div class="ui breadcrumb">
        <div class="c-breadcrumb">
          ...
          <i class="right angle icon divider"></i>
          <div class="section">女性向け転職サイト・転職エージェント総合ランキング</div>
        </div>
      </div>
      <h1 class="c-hero__title">女性向け転職サイト・転職エージェント総合ランキング</h1>
    </div>
  </div>
</div>
<div class="l-main">
      ...
      <div class="l-main_lf_2">
        ...
        <div class="c-ranking">
          ...
          <div class="ui items c-ranking__summary">
            <div class="item">
              <a href="{{ action('WomanController@show', $ranking->service_id )}}" class="ui small image">
          ...
          <div class="c-ranking__description">
            ...
            <div class="c-double__buttons">
              <button class="ui orange button c-button"><a href="{{ action('WomanController@show', $ranking->service_id) }}">クチコミ・詳細を見る</a></button>
