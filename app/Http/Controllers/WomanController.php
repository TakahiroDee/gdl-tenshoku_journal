...
class WomanController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('woman.index',compact('pages','posts','rankings','reputations'));
    }
    ...
    public function show($service_id)
    {
        ...
        return view('woman.show',compact('contents','good_reps','bad_reps','recent_reps','pages','posts'));
    }
}
