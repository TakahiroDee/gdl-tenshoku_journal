...
class AgentController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('agent.index',compact('pages','posts','rankings','reputations'));
    }
    ...
    public function show($service_id)
    {
        ...
        return view('agent.show',compact('contents','good_reps','bad_reps','recent_reps','pages','posts'));
    }
}
